...
namespace Microsoft.MixedReality.GraphicsTools.Editor
{
    ...
    public static class DevelopmentUtilities
    {
        ...
        private static readonly string visibleSamplesPath = "../../MRGT/Samples";
        private static readonly string hiddenSamplesPath = "../../MRGT/Samples~";
        ...
        {
            Shader debugShader = Shader.Find("Graphics Tools/Hidden/DebugMipColor");
            ...
            {
                Debug.LogWarning("Failed to find \"Graphics Tools/Hidden/DebugMipColor\" shader.");
            }
        }
